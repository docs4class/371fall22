...
\CommentTok{\#\textgreater{} [1] "Mon Sep 19 10:12:48 2022"}
\end{Highlighting}
\end{Shaded}
...
\chapter{Exam 1 study guide:}\label{exam-1-study-guide}}
...
\def\labelenumi{\arabic{enumi}.}
\item
  Load the ``rock'' data set. How many observations and variables are in the `rock' data set?
\item
  What was the purpose of this dataset?
\item
  What are the units of measurement for `peri'?
\item
  In the `rock' data set what is the standard deviation of area? \textbf{2683.8488617}
\item
  How many rocks have an area of greater than 4333? \textbf{41}
\item
  How many rocks have an area of greater than 4333 and less than 7333? \textbf{14}
\item
  Create a variable called `good.fun' which is area divided by perimeter squared. What is the average of `good.fun'? \textbf{0.0020362}
\item
  Add a new observation that to this dataframe that has an `area' of 17777, `peri' of 7777, `shape' of 7777, and a `perm' of 7777. Can you do this?
\item
  What is the mean of area for including the new rock you have added?
\item
  Using the `women' data set, what is the average BMI for all women?
\item
  What is ths average BMI for `women'?
\item
  What is the correlation between height and weight in the 'women'' dataset?
\item
  Make a histogram plot of the area variable from `rock'.
\item
  Use a bivariate plot of rock data to identify which variable are most correlated. Confirm your answer with a correlation table?
\item
  Do this math in R: 3333 squared divided by the square root of 78.
\item
  Make this sequence using rep and seq functions: \textbf{1 2 3 1 2 3 1 2 3 1 2 3}
\item
  Make this sequence using rep and seq functions: \textbf{97, 96, 95, 94, 93, 92, 91, 90, 89, 97, 96, 95, 94, 93, 92, 91, 90, 89, 97, 96, 95, 94, 93, 92, 91, 90, 89}
\item
  Make this plot:
  \includegraphics{19-Exam_1_study_guide_files/figure-latex/unnamed-chunk-1-1.pdf}
\item
  What is the heaviest car in the `mtcars' dataset in kg?
\item
  How many cars in `mtcars' dataset have more than 4 cylinders?
\item
  Create this dataframe called `Gerry':
\item
  Add column called `aa' to \texttt{Gerry} which are the numbers \textbf{11120, 11121, 11122, 11123, 11124, 11125, 11126, 11127, 11128, 11129}
\item
...
\includegraphics{88-anscombe_files/figure-latex/unnamed-chunk-4-1.pdf}
